...
<head>
    ...
    <style type="text/css"><%@include file="/static/css/cssbase-min.css"%></style>
    <style type="text/css"><%@include file="/static/css/fonts.css"%></style>
    <style type="text/css"><%@include file="/static/css/fontello-ie7.css"%></style>
    <style type="text/css"><%@include file="/static/css/fontello-embedded.css"%></style>
    <style type="text/css"><%@include file="/static/css/fontello.css"%></style>
    <style type="text/css"><%@include file="/static/css/style.css"%></style>
    <style type="text/css"><%@include file="/static/css/layout-colors.css"%></style>
    <style type="text/css"><%@include file="/static/css/responsive-style.css"%></style>
    <style type="text/css"><%@include file="/static/css/guia-do-programador-style.css"%></style>
    <style type="text/css"><%@include file="/static/css/produtos.css"%></style>
</head>
<body>
...
<article id="${book.id}">
        ...
        <form action="/cart/add" method="post" class="container">
            <ul id="variants" class="clearfix">
                ...
                <c:forEach items="${book.prices}" var="price">
                    <li class="buy-option">
                        <input type="radio" name="type" class="variant-radio" value="${price.type}" id="type" checked="checked"  />
                        <label class="variant-label" for="type">
                            ${price.type}
                        </label>
    ...
    <div class="container">
        ...
        <section class="data product-detail">
            ...
            <p></p>
            <p>Data de publicação: ${book.releaseDate} </p>
